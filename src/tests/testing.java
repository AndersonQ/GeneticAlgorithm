...
public class testing
{
	public static void main(String[] trash)
	{
		System.out.println("Algoritmo Genético para pontos ótimos de funções");
		...
		while(op > 0)
		{
			...
			while (txmutation <= 0 || txmutation > 80) {
				System.out.printf("\nEscolha a taxa de mutação, real de 0 a 80 :\n");
				System.out.printf("> ");
			...
			System.out.printf("1 - Maximizar função\n");
			System.out.printf("2 - Minimizar função\n");
